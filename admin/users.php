                            ...
                            <table id="zero_config" class="table table-striped table-bordered w-100 table">
                                ...
                                <tbody>
                                    ...
                                    <td class="h3">
                                        ...
                                        <a href="javascript:delete_post(<?php echo $user['user_id']; ?>)"
                                            data-toggle="tooltip" data-placement="top" data-original-title="Delete"
                                            class="px-1 mx-1 btn-outline-danger"><i class="mdi mdi-delete"></i></a>
                                        <?php } ?>
                                        <a href="./edit-profile.php?user-id=<?php echo $user['user_id']; ?>"
                                            data-toggle="tooltip" data-placement="top" data-original-title="Edit"
                                            class="px-1 mx-1 btn-outline-success"> <i class="mdi mdi-pen"></i></a>
                                    </td>
                                    <?php
                                                    echo "</tr>";
                                                    $counter++;
