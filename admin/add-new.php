    ...
    <div class="container-fluid">
        ...
        <form action="./savedata.php" class="row" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-12 form-group my-20">
                ...
                <input type="text" name="post-title" class="form-control font-weight-normal shadow p-2" id=""
                    placeholder="Enter Topic Here!" required>
            </div>
            ...
            <div class="my-3  p-2 col-12 col-md-4">
                <div class="form-group">
                    ...
                    <select class="form-control" id="cat_title" name="post-type">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control  p-2" id="" name="post-author" placeholder="Author Name"
                        value="<?php //echo $_SESSION['login_fullname']; ?>">
                </div>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary" name="save-post" value="publish">Publish <i
