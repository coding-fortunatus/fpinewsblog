...
<section class="single-post-area">
    ...
    <div class="single-post-title bg-img background-overlay"
        style="background-image: url(./uploads/<?php echo $post_image; ?>);">
                ...
                <div class="col-12">
                    <div class="single-post-title-content">
                        ...
                        <div class="theme-post-tag">
                            <a
                                href="./catagory.php?category=<?php echo $post_category; ?>"><?php echo $post_category; ?></a>
                        </div>
                        <h2 class="font-pt"><?php echo $post_title; ?></h2>
                        <p><?php echo $post_date; ?> <span class="ml-4">[ Post Hits : <?php echo $post_visit_counter; ?>
                                ]</span> </p>
                        ...
                        <li class="single_comment_area">
                            <div class="comment-wrapper d-md-flex align-items-start">
                                ...
                                <div class="comment-content">
                                    ...
                                    <span
                                        class="comment-date font-pt"><?php echo date("F j, Y",strtotime($comment['comment_date'])); ?></span>
                        ...
                        <form action="./savecomment.php" method="POST">
                            <div class="form-group">
                                <input type="text" class="form-control" id="comment_author"
                                    placeholder="Enter Your Full Name" name="comment_author">
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" class="btn leave-comment-btn" name="save_comment"
                                value="submit">SUBMIT <i class="fa fa-angle-right ml-2"></i></button>
                        </form>
                    </div>
                </div>
            </div>
