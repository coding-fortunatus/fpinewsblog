            ...
            <div class="col-12 col-lg-9">
                ...
                <div class="theme-welcome-post">
                    ...
                    <div class="theme-post-tag">
                        <a href="./catagory.php?category=<?php echo $welpost['post_type']; ?>">
                            <?php echo $welpost['post_type']; ?>
                        </a>
                    </div>
                    <h2 class="font-pt">
                        <?php echo $welpost['post_title']; ?>
                    </h2>
                    <p class="theme-post-date">
                        <?php echo date("F j, Y", strtotime($welpost['post_date'])); ?>
                    </p>
                    <!-- Post Thumbnail -->
                    ...
                    <div class="post-continue-reading-share d-sm-flex align-items-center justify-content-between mt-30">
                        <div class="post-continue-btn">
                            <a href="./post.php?id=<?php echo $welpost['post_id']; ?>" class="font-pt">Continue Reading
                    ...
                    foreach ($brnewss as $brnews) { ?>
                        ...
                        <div class="single-breaking-news-widget">
                            ...
                            <div class="breaking-news-heading gradient-background-overlay">
                                <h5 class="font-pt"><a href="./post.php?id=<?php echo $brnews['post_id']; ?>"
                                        style="color:inherit;font:inherit;"><?php echo $brnews['post_title']; ?></a>
                                </h5>
                            </div>
                        </div>
                        <?php } ?>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-3 col-sm-6">
                    ...
                    <div class="theme-single-catagory-post">
                        ...
                        <div class="theme-post-tag">
                            <a
                                href="./catagory.php?category=<?php echo $lpost['post_type']; ?>"><?php echo $lpost['post_type']; ?></a>
                        </div>
                        <h5><a href="./post.php?id=<?php echo $lpost['post_id']; ?>"
                                class="font-pt"><?php echo $lpost['post_title']; ?></a></h5>
